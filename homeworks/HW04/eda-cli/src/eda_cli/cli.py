...
def report(
    ...
    top_k_categories: int = typer.Option(5, help="Количество top-значений для категориальных."),
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Порог пропусков для проблемных: **{min_missing_share:.1%}**\n\n")
        ...
        f.write(f"- Константные столбцы: **{quality_flags['has_constant_columns']}**\n")
        f.write(f"- Слишком много уникальных значений в столбце: **{quality_flags['has_high_cardinality_categoricals']}**\n")
        ...
        if not top_cats:
            ...
            f.write(f"Top-{top_k_categories} значений для каждого признака.\n\n")
            f.write("См. файлы в папке `top_categories/`.\n\n")

        f.write("## Гистограммы числовых колонок\n\n")
        f.write(f"Максимум {max_hist_columns} столбцов.\n\n")
